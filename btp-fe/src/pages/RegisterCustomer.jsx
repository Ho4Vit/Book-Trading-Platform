...
import { User, ShieldCheck, Mail, Lock, Phone, UserCircle, ArrowRight, ArrowLeft, BookOpen, Sparkles, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 p-4 relative overflow-hidden">
      ...
      >
        <Card className="border-2 shadow-2xl overflow-hidden backdrop-blur-sm bg-card/95">
          <CardHeader className="bg-gradient-to-br from-primary/10 to-purple-500/10 border-b pb-8">
            <div className="flex items-center justify-center mb-4">
              <motion.div
                className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-purple-600 flex items-center justify-center shadow-lg"
            ...
            <CardTitle className="text-4xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-primary via-purple-600 to-pink-600">
              Đăng ký Khách hàng
            </CardTitle>
          ...
          <CardContent className="pt-8">
            ...
            {step === 1 && (
              ...
              >
                ...
                <Button
                  type="submit"
                  className="w-full h-12 text-base font-semibold bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 shadow-lg group"
            ...
            {step === 2 && (
              ...
              >
                <div className="text-center space-y-3">
                  <motion.div
                    className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-primary/20 to-purple-500/20 flex items-center justify-center border-2 border-primary/30"
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    className="flex-1 h-12 bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 shadow-lg group"
