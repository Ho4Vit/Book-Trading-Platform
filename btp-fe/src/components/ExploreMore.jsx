				...
				<div>
					<div className="flex items-center justify-between mb-8">
						<div>
							...
							<p className="text-muted-foreground">
								Những cuốn sách đang được yêu thích
							</p>
						</div>
						{showViewAll && (
							<Button
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
						{booksToShow.map((trendingBook, index) => {
							const isTrendingOutOfStock =
								trendingBook.stock === 0 ||
								trendingBook.stock === null;
							return (
									...
									>
										<div className="relative aspect-[3/4] overflow-hidden bg-muted">
											<img
												src={
													...
													trendingBook.coverImage !== "string"
														? trendingBook.coverImage
											...
											<BookRating bookId={trendingBook.id || trendingBook._id} />
										</div>
										...
										<CardFooter className="pt-0 flex items-center justify-between">
											...
											<Button
												...
												onClick={(e) =>
													handleQuickAddToCart(trendingBook, e)
												}
												disabled={
